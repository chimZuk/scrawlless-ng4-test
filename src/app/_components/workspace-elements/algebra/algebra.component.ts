...
export class AlgebraComponent {
  ...
  getExpression(line) {
    ...
    let dragHandler = `<g transform="translate(-20, -20)" class="drag-handler" data-lineID="` + this.line.id + `"><path data-lineID="` + this.line.id + `" fill="#FFFFFF" stroke = "#F15A24" stroke-width="1.5" class="drag-handler" d="M20,12.5c0,2,0,7.5,0,7.5s-5.4,0-7.5,0C8.4,20,5,16.6,5,12.5S8.4,5,12.5,5S20,8.4,20,12.5z"/></g>`;
