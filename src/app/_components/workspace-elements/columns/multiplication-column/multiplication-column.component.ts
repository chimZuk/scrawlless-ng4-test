...
@Component({
  selector: 'multiplication-column',
  templateUrl: './multiplication-column.component.html',
  styleUrls: ['./multiplication-column.component.css'],
  host: {
    '(document:keydown)': 'handleKeyboardEvents($event)'
  }
})
export class MultiplicationColumnComponent {
